...
interface InterfaceFixture1
{
	 ...
	 * @var string
	 */
	public const string DATE_TIME_STRING_1 = Values::DATE_TIME_STRING_1;

	/**
	 * Represents an array of `DateTime string` values.
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_ARRAY_1 = Values::DATE_TIME_STRING_ARRAY_1;

	/**
	 * Represents an array of mixed `DateTime string` values.
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_MIXED_ARRAY_1 = Values::DATE_TIME_STRING_MIXED_ARRAY_1;
