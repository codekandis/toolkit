...
interface InterfaceFixture2
{
	 ...
	 * @var string
	 */
	public const string DATE_TIME_STRING_2 = Values::DATE_TIME_STRING_2;

	/**
	 * Represents an array of `DateTime string` values.
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_ARRAY_2 = Values::DATE_TIME_STRING_ARRAY_2;

	/**
	 * Represents an array of mixed `DateTime string` values.
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_MIXED_ARRAY_2 = Values::DATE_TIME_STRING_MIXED_ARRAY_2;
