...
abstract class Values
{
	 ...
	 * @var string
	 */
	public const string DATE_TIME_STRING_1 = '1990-05-14 12:24:42.123456';

	/**
	 * Represents a `string` representing a `DateTime` value.
	 * @var string
	 */
	public const string DATE_TIME_STRING_2 = '12:24:42.123456 1990-05-14';

	/**
	 * Represents an array of `DateTime string` values.
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_ARRAY_1 = [
		self::DATE_TIME_STRING_1,
		self::DATE_TIME_STRING_1
	];
	 ...
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_ARRAY_2 = [
		self::DATE_TIME_STRING_2,
		self::DATE_TIME_STRING_2
	];
	 ...
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_MIXED_ARRAY_1 = [
		self::DATE_TIME_STRING_1,
		self::DATE_TIME_STRING_2
	];
	 ...
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_MIXED_ARRAY_2 = [
		self::DATE_TIME_STRING_2,
		self::DATE_TIME_STRING_1
	];

	/**
	 * Represents a `string` representing a `DateTime` value with null bytes.
	 * @var string
	 */
	public const string DATE_TIME_STRING_WITH_NULL_BYTES_1 = "1990-05-14\012:24:42.123456\0";

	/**
	 * Represents a `string` representing a `DateTime` value with null bytes.
	 * @var string
	 */
	public const string DATE_TIME_STRING_WITH_NULL_BYTES_2 = "12:24:42.123456\01990-05-14\0";

	/**
	 * Represents an array of `DateTime string` values with null bytes.
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_WITH_NULL_BYTES_ARRAY_1 = [
		self::DATE_TIME_STRING_WITH_NULL_BYTES_1,
		self::DATE_TIME_STRING_WITH_NULL_BYTES_1
	];
	 ...
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_WITH_NULL_BYTES_ARRAY_2 = [
		self::DATE_TIME_STRING_WITH_NULL_BYTES_2,
		self::DATE_TIME_STRING_WITH_NULL_BYTES_2
	];

	/**
	 * Represents an array of mixed `DateTime string` values with null bytes.
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_WITH_NULL_BYTES_MIXED_ARRAY_1 = [
		self::DATE_TIME_STRING_WITH_NULL_BYTES_1,
		self::DATE_TIME_STRING_WITH_NULL_BYTES_2
	];
	 ...
	 * @var string[]
	 */
	public const array DATE_TIME_STRING_WITH_NULL_BYTES_MIXED_ARRAY_2 = [
		self::DATE_TIME_STRING_WITH_NULL_BYTES_2,
		self::DATE_TIME_STRING_WITH_NULL_BYTES_1
	];
	 ...
	 * @var string
	 */
	public const string DATE_TIME_FORMAT_1 = 'Y-m-d H:i:s.u';

	/**
	 * Represents a `DateTime` format.
	 * @var string
	 */
	public const string DATE_TIME_FORMAT_2 = 'H:i:s.u Y-m-d';

	/**
	 * Represents a `DateTimeZone string`.
	 * @var string
	 */
	public const string DATE_TIMEZONE_STRING_1 = 'UTC';

	/**
	 * Represents a `DateTimeZone string`.
	 * @var string
	 */
	public const string DATE_TIMEZONE_STRING_2 = 'Europe/Berlin';

	/**
	 * Represents an array of `DateTimeZone string`.
	 * @var string[]
	 */
	public const array DATE_TIMEZONE_STRING_ARRAY_1 = [
		self::DATE_TIMEZONE_STRING_1,
		self::DATE_TIMEZONE_STRING_1
	];
	 ...
	 * @var string[]
	 */
	public const array DATE_TIMEZONE_STRING_ARRAY_2 = [
		self::DATE_TIMEZONE_STRING_2,
		self::DATE_TIMEZONE_STRING_2
	];
	 ...
	 * @var string[]
	 */
	public const array DATE_TIMEZONE_STRING_MIXED_ARRAY_1 = [
		self::DATE_TIMEZONE_STRING_1,
		self::DATE_TIMEZONE_STRING_2
	];
	 ...
	 * @var string[]
	 */
	public const array DATE_TIMEZONE_STRING_MIXED_ARRAY_2 = [
		self::DATE_TIMEZONE_STRING_2,
		self::DATE_TIMEZONE_STRING_1
	];
	...
	/**
	 * Represents a `DateTimeImmutableObject`.
	...
	/**
	 * Represents a `DateTimeZoneObject`.
	 * @var DateTimeZone
	 */
	...
	/**
	 * Represents a `DateIntervalObject`.
	 * @var DateInterval
	 */
	...
	{
		return self::$dateTimeImmutableObject1 ??= new DateTimeImmutable( Values::DATE_TIME_STRING_1 );
	}
	...
	{
		return self::$dateTimeImmutableObject2 ??= new DateTimeImmutable( Values::DATE_TIME_STRING_2 );
	}
	...
	{
		return self::$dateTimeObject1 ??= new DateTime( Values::DATE_TIME_STRING_1 );
	}
	...
	{
		return self::$dateTimeObject2 ??= new DateTime( Values::DATE_TIME_STRING_2 );
	}
	...
	{
		return self::$dateTimeZoneObject1 ??= new DateTimeZone( Values::DATE_TIMEZONE_STRING_1 );
	}
	...
	{
		return self::$dateTimeZoneObject2 ??= new DateTimeZone( Values::DATE_TIMEZONE_STRING_2 );
	}
	...
	public static function createMixedValuesArray1(): array
	{
		return [
			...
			static::DATE_TIME_STRING_1,
			static::DATE_TIME_STRING_ARRAY_1,
			static::DATE_TIME_STRING_MIXED_ARRAY_1,
			static::DATE_TIME_FORMAT_1,
			static::DATE_TIMEZONE_STRING_1,
			static::DATE_TIMEZONE_STRING_ARRAY_1,
			static::DATE_TIMEZONE_STRING_MIXED_ARRAY_1,
	...
	public static function createMixedValuesArray2(): array
	{
		return [
			...
			static::DATE_TIME_STRING_2,
			static::DATE_TIME_STRING_ARRAY_2,
			static::DATE_TIME_STRING_MIXED_ARRAY_2,
			static::DATE_TIME_FORMAT_2,
			static::DATE_TIMEZONE_STRING_2,
			static::DATE_TIMEZONE_STRING_ARRAY_2,
			static::DATE_TIMEZONE_STRING_MIXED_ARRAY_2,
