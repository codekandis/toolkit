...
/**
 * Represents a data provider providing validators with expected validators.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ValidatorsWithExpectedValidatorsDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
