...
class ValidatorsWithValueAndExpectedValidationResultDataProvider0075 implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			...
			75189 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIME_STRING_ARRAY_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_TRUE
			],
			75190 => [
			...
			75402 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIME_STRING_ARRAY_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_TRUE
			],
			75403 => [
			...
			75615 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIME_STRING_MIXED_ARRAY_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_TRUE
			],
			75616 => [
