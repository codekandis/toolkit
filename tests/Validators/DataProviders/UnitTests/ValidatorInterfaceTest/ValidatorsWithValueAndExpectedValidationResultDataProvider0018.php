...
class ValidatorsWithValueAndExpectedValidationResultDataProvider0018 implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			...
			18105 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIMEZONE_STRING_ARRAY_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			18106 => [
			...
			18318 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIMEZONE_STRING_ARRAY_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			18319 => [
			...
			18531 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			18532 => [
			...
			18744 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			18745 => [
