...
class ValidatorsWithValueAndExpectedValidationResultDataProvider0005 implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			...
			5112 => [
				'validator'                => new IsDateTimeStringArrayByFormatValidator(Values::DATE_TIME_FORMAT_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			5113 => [
			...
			5325 => [
				'validator'                => new IsDateTimeStringArrayByFormatValidator(Values::DATE_TIME_FORMAT_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			5326 => [
			...
			5751 => [
				'validator'                => new IsDateTimeStringByFormatValidator(Values::DATE_TIME_FORMAT_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			5752 => [
