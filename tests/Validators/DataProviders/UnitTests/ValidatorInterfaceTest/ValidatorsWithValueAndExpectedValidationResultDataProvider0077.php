...
class ValidatorsWithValueAndExpectedValidationResultDataProvider0077 implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			...
			77106 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIMEZONE_STRING_ARRAY_2),
				'value'                    => Values::NULL,
			...
			77319 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_TRUE
			],
			77320 => [
			...
			77532 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_TRUE
			],
			77533 => [
