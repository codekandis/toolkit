...
class ValidatorsWithValueAndExpectedValidationResultDataProvider0017 implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			17000 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIME_STRING_MIXED_ARRAY_1),
			...
			17040 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIME_STRING_MIXED_ARRAY_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			17041 => [
			...
			17253 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIME_STRING_WITH_NULL_BYTES_ARRAY_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			17254 => [
			...
			17466 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIME_STRING_WITH_NULL_BYTES_ARRAY_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			17467 => [
			...
			17679 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIME_STRING_WITH_NULL_BYTES_MIXED_ARRAY_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			17680 => [
			...
			17892 => [
				'validator'                => new IsInArrayValidator(Values::DATE_TIME_STRING_WITH_NULL_BYTES_MIXED_ARRAY_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_FALSE
			],
			17893 => [
