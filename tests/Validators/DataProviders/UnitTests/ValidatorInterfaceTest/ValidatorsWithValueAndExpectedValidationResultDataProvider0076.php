...
class ValidatorsWithValueAndExpectedValidationResultDataProvider0076 implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			76000 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIME_STRING_MIXED_ARRAY_2),
			...
			76041 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIME_STRING_WITH_NULL_BYTES_ARRAY_1),
				'value'                    => Values::NULL,
			...
			76254 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIME_STRING_WITH_NULL_BYTES_ARRAY_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_TRUE
			],
			76255 => [
			...
			76467 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIME_STRING_WITH_NULL_BYTES_MIXED_ARRAY_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_TRUE
			],
			76468 => [
			...
			76680 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIME_STRING_WITH_NULL_BYTES_MIXED_ARRAY_2),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_TRUE
			],
			76681 => [
			...
			76893 => [
				'validator'                => new NullableIsInArrayValidator(Values::DATE_TIMEZONE_STRING_ARRAY_1),
				'value'                    => Values::NULL,
				'expectedValidationResult' => Values::BOOLEAN_TRUE
			],
			76894 => [
