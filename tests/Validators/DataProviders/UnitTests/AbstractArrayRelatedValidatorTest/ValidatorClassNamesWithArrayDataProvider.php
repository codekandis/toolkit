...
class ValidatorClassNamesWithArrayDataProvider implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			...
			36  => [
				'validatorClassName' => IsInArrayValidator::class,
				'array'              => Values::DATE_TIME_STRING_ARRAY_1
			],
			37  => [
				'validatorClassName' => IsInArrayValidator::class,
				'array'              => Values::DATE_TIME_STRING_ARRAY_2
			],
			38  => [
				'validatorClassName' => IsInArrayValidator::class,
				'array'              => Values::DATE_TIME_STRING_MIXED_ARRAY_1
			],
			39  => [
				'validatorClassName' => IsInArrayValidator::class,
				'array'              => Values::DATE_TIME_STRING_MIXED_ARRAY_2
			],
			40  => [
				'validatorClassName' => IsInArrayValidator::class,
				'array'              => Values::DATE_TIMEZONE_STRING_ARRAY_1
			],
			41  => [
				'validatorClassName' => IsInArrayValidator::class,
				'array'              => Values::DATE_TIMEZONE_STRING_ARRAY_2
			],
			42  => [
				'validatorClassName' => IsInArrayValidator::class,
				'array'              => Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_1
			],
			43  => [
				'validatorClassName' => IsInArrayValidator::class,
				'array'              => Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_2
			],
			44  => [
				'validatorClassName' => IsInArrayValidator::class,
