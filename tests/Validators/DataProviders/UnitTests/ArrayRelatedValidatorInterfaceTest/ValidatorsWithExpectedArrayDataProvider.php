...
class ValidatorsWithExpectedArrayDataProvider implements DataProviderInterface
{
	...
	public static function provideData(): iterable
	{
		return [
			...
			36  => [
				'validator'     => new IsInArrayValidator( $array = Values::DATE_TIME_STRING_ARRAY_1 ),
				'expectedArray' => $array
			],
			37  => [
				'validator'     => new IsInArrayValidator( $array = Values::DATE_TIME_STRING_ARRAY_2 ),
				'expectedArray' => $array
			],
			38  => [
				'validator'     => new IsInArrayValidator( $array = Values::DATE_TIME_STRING_MIXED_ARRAY_1 ),
				'expectedArray' => $array
			],
			39  => [
				'validator'     => new IsInArrayValidator( $array = Values::DATE_TIME_STRING_MIXED_ARRAY_2 ),
				'expectedArray' => $array
			],
			40  => [
				'validator'     => new IsInArrayValidator( $array = Values::DATE_TIMEZONE_STRING_ARRAY_1 ),
				'expectedArray' => $array
			],
			41  => [
				'validator'     => new IsInArrayValidator( $array = Values::DATE_TIMEZONE_STRING_ARRAY_2 ),
				'expectedArray' => $array
			],
			42  => [
				'validator'     => new IsInArrayValidator( $array = Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_1 ),
				'expectedArray' => $array
			],
			43  => [
				'validator'     => new IsInArrayValidator( $array = Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_2 ),
				'expectedArray' => $array
			],
			44  => [
			...
			148 => [
				'validator'     => new NullableIsInArrayValidator( $array = Values::DATE_TIME_STRING_ARRAY_1 ),
				'expectedArray' => $array
			],
			149 => [
				'validator'     => new NullableIsInArrayValidator( $array = Values::DATE_TIME_STRING_ARRAY_2 ),
				'expectedArray' => $array
			],
			150 => [
				'validator'     => new NullableIsInArrayValidator( $array = Values::DATE_TIME_STRING_MIXED_ARRAY_1 ),
				'expectedArray' => $array
			],
			151 => [
				'validator'     => new NullableIsInArrayValidator( $array = Values::DATE_TIME_STRING_MIXED_ARRAY_2 ),
				'expectedArray' => $array
			],
			152 => [
				'validator'     => new NullableIsInArrayValidator( $array = Values::DATE_TIMEZONE_STRING_ARRAY_1 ),
				'expectedArray' => $array
			],
			153 => [
				'validator'     => new NullableIsInArrayValidator( $array = Values::DATE_TIMEZONE_STRING_ARRAY_2 ),
				'expectedArray' => $array
			],
			154 => [
				'validator'     => new NullableIsInArrayValidator( $array = Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_1 ),
				'expectedArray' => $array
			],
			155 => [
				'validator'     => new NullableIsInArrayValidator( $array = Values::DATE_TIMEZONE_STRING_MIXED_ARRAY_2 ),
				'expectedArray' => $array
			],
			156 => [
