...
namespace CodeKandis\ToolKit\Tests\Converters\DataProviders\UnitTests\UniDirectionalConverters\NullableIntegerBackedEnumValuesToNullableKeyValuePairsArrayUniDirectionalConverterInterfaceTest;
	...
	public static function provideData(): iterable
	{
		return [
			0  => [
				...
				'expectedThrowableMessage'   => sprintf( InvalidValueException::EXCEPTION_MESSAGE_WITH_INVALID_VALUE_AND_EXPECTED_VALUES, $invalidValue, Values::INTEGER_BACKED_ENUM_NAME_VALUE )
			],
			1  => [
				'uniDirectionalConverter'    => new NullableIntegerBackedEnumValuesToNullableKeyValuePairsArrayUniDirectionalConverter(),
