...
namespace CodeKandis\ToolKit\Tests\Converters\DataProviders\UnitTests\UniDirectionalConverters\NullableInterfaceConstantsToNullableArrayUniDirectionalConverterInterfaceTest;
	...
	public static function provideData(): iterable
	{
		return [
			0  => [
				...
				'expectedThrowableMessage'   => sprintf( InvalidValueException::EXCEPTION_MESSAGE_WITH_INVALID_VALUE_AND_EXPECTED_VALUES, $invalidValue, Values::INTERFACE_NAME_VALUE )
			],
			1  => [
				'uniDirectionalConverter'    => new NullableInterfaceConstantsToNullableArrayUniDirectionalConverter(),
