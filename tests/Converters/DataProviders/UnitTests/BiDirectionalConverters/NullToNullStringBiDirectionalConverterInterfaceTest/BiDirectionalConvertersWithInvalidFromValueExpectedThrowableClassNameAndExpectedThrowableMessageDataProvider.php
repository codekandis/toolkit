...
namespace CodeKandis\ToolKit\Tests\Converters\DataProviders\UnitTests\BiDirectionalConverters\NullToNullStringBiDirectionalConverterInterfaceTest;
	...
	public static function provideData(): iterable
	{
		return [
			0  => [
				...
				'expectedThrowableMessage'   => sprintf( InvalidValueException::EXCEPTION_MESSAGE_WITH_INVALID_VALUE_AND_EXPECTED_VALUES, $invalidFromValue, Values::NULL_STRING )
			],
			1  => [
				'biDirectionalConverter'     => new NullToNullStringBiDirectionalConverter(),
