...
/**
 * Represents a data provider providing expected types with expected `nullableBoolean` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ExpectedTypesWithExpectedNullableBooleanValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedNullableBooleanValue' => ExpectedTypes::NULLABLE_BOOLEAN
			]
		];
	}
}
