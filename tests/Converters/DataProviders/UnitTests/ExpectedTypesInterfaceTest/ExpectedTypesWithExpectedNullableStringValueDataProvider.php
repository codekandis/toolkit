...
/**
 * Represents a data provider providing expected types with expected `nullableString` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ExpectedTypesWithExpectedNullableStringValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedNullableStringValue' => ExpectedTypes::NULLABLE_STRING
			]
		];
	}
}
