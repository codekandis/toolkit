...
/**
 * Represents a data provider providing expected types with expected `boolean` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ExpectedTypesWithExpectedBooleanValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedBooleanValue' => ExpectedTypes::BOOLEAN
			]
		];
	}
}
