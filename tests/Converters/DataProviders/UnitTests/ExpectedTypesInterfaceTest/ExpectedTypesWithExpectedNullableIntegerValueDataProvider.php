...
/**
 * Represents a data provider providing expected types with expected `nullableInteger` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ExpectedTypesWithExpectedNullableIntegerValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedNullableIntegerValue' => ExpectedTypes::NULLABLE_INTEGER
			]
		];
	}
}
