...
/**
 * Represents a data provider providing expected types with expected `nullableBooleanArray` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ExpectedTypesWithExpectedNullableBooleanArrayValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedNullableBooleanArrayValue' => ExpectedTypes::NULLABLE_BOOLEAN_ARRAY
			]
		];
	}
}
