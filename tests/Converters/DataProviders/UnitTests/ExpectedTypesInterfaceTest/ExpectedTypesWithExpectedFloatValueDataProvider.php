...
/**
 * Represents a data provider providing expected types with expected `float` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ExpectedTypesWithExpectedFloatValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedFloatValue' => ExpectedTypes::FLOAT
			]
		];
	}
}
