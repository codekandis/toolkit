...
/**
 * Represents a data provider providing expected types with expected `nullableFloat` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ExpectedTypesWithExpectedNullableFloatValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedNullableFloatValue' => ExpectedTypes::NULLABLE_FLOAT
			]
		];
	}
}
