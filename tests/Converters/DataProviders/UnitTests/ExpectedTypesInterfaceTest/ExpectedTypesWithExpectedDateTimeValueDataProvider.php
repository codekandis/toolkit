...
/**
 * Represents a data provider providing expected types with expected `dateTime` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ExpectedTypesWithExpectedDateTimeValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedDateTimeValue' => ExpectedTypes::DATE_TIME
			]
		];
	}
}
