...
/**
 * Represents a data provider providing valid values with expected `regExBooleanString` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ValidValuesWithExpectedRegExBooleanStringValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedRegExBooleanStringValue' => ValidValues::REG_EX_BOOLEAN_STRING
			]
		];
	}
}
