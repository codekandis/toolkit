...
/**
 * Represents a data provider providing valid values with expected `booleanIntegerSet` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ValidValuesWithExpectedBooleanIntegerSetValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedBooleanIntegerSetValue' => ValidValues::BOOLEAN_INTEGER_SET
			]
		];
	}
}
