...
/**
 * Represents a data provider providing valid values with expected `className` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ValidValuesWithExpectedClassNameValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedClassNameValue' => ValidValues::CLASS_NAME
			]
		];
	}
}
