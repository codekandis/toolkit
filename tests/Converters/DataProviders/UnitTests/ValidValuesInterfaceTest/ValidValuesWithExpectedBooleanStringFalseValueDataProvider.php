...
/**
 * Represents a data provider providing valid values with expected `booleanStringFalse` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ValidValuesWithExpectedBooleanStringFalseValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedBooleanStringFalseValue' => ValidValues::BOOLEAN_STRING_FALSE
			]
		];
	}
}
