...
/**
 * Represents a data provider providing valid values with expected `regExIntegerString` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ValidValuesWithExpectedRegExIntegerStringValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedRegExIntegerStringValue' => ValidValues::REG_EX_INTEGER_STRING
			]
		];
	}
}
