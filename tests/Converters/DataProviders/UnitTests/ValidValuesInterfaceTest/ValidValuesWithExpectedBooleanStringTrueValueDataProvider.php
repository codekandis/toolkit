...
/**
 * Represents a data provider providing valid values with expected `booleanStringTrue` value.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class ValidValuesWithExpectedBooleanStringTrueValueDataProvider implements DataProviderInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'expectedBooleanStringTrueValue' => ValidValues::BOOLEAN_STRING_TRUE
			]
		];
	}
}
