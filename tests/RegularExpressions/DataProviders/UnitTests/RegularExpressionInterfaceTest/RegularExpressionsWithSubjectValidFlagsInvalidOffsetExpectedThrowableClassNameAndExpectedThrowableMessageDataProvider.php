	...
	public static function provideData(): iterable
	{
		return [
			0 => [
				...
				'subject'                    => Values::SIMPLE_SUBJECT,
				'validFlags'                 => RegularExpressionMatchFlag::None->value,
				'invalidOffset'              => $invalidOffset = Values::INVALID_OFFSET,
				'expectedThrowableClassName' => OffsetOutOfRangeException::class,
				'expectedThrowableMessage'   => sprintf( OffsetOutOfRangeException::EXCEPTION_MESSAGE_WITH_OUT_OF_RANGE_OFFSET_EXPECTED_MIN_OFFSET_AND_EXPECTED_MAX_OFFSET, $invalidOffset, -Values::SIMPLE_SUBJECT_LENGTH, Values::SIMPLE_SUBJECT_LENGTH )
			],
			1 => [
				'regularExpression'          => new RegularExpression( Values::SIMPLE_GROUPED_REGULAR_EXPRESSION ),
				'subject'                    => Values::SIMPLE_SUBJECT,
