...
/**
 * Represents the interface of any unidirectional converter converting a `float string` value matching the regular expression {@link ValidValues::$regExFloatString} into its corresponding `float` value.
