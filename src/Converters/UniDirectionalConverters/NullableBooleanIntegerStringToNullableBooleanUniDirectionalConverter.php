...
/**
 * Represents a unidirectional converter converting a `nullable boolean integer string` value matching the regular expression {@link ValidValues::$regExBooleanIntegerString} into its corresponding `nullable boolean` value equal to {@link ValidValues::$booleanFalse} or {@link ValidValues::$booleanTrue}.
...
class NullableBooleanIntegerStringToNullableBooleanUniDirectionalConverter extends AbstractConverter implements NullableBooleanIntegerStringToNullableBooleanUniDirectionalConverterInterface
{
	...
	public function convert( mixed $value ): ?bool
	{
		...
		try
		{
			$validator = new IsMatchingRegularExpressionValidator( $this->validValues->regExBooleanIntegerString );
		}
