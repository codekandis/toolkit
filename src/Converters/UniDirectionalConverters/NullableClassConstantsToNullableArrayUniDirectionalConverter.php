...
/**
 * Represents a unidirectional converter converting the constants of a `nullable class` into a `nullable array` of corresponding key value pairs.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
class NullableClassConstantsToNullableArrayUniDirectionalConverter extends AbstractConverter implements NullableClassConstantsToNullableArrayUniDirectionalConverterInterface
{
	/**
	 * @inheritdoc
