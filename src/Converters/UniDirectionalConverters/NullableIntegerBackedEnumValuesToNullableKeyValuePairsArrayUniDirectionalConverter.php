 ...
 */
class NullableIntegerBackedEnumValuesToNullableKeyValuePairsArrayUniDirectionalConverter extends AbstractConverter implements NullableIntegerBackedEnumValuesToNullableKeyValuePairsArrayUniDirectionalConverterInterface
{
	/**
	 * @inheritdoc
