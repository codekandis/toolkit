...
/**
 * Represents the interface of any bidirectional converter converting a `float string` value matching the regular expression {@link ValidValues::$regExFloatString} into its corresponding `float` value - and vice versa.
 * @package codekandis/toolkit
 * @author Christian Ramelow <info@codekandis.net>
 */
interface FloatStringToFloatBiDirectionalConverterInterface extends BiDirectionalConverterInterface
{
	/**
