...
/**
 * Represents the interface of any bidirectional converter converting an `integer string` value matching the regular expression {@link ValidValues::$regExIntegerString} into its corresponding `integer` value - and vice versa.
