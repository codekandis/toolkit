 ...
 */
class IsDateIntervalStringArrayValidator extends BaseObject implements IsDateIntervalStringArrayValidatorInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public function validate( mixed $value ): bool
	{
		...
		$elementValidator = new IsDateIntervalStringValidator();
