 ...
 */
class IsNonEmptyStringArrayValidator extends BaseObject implements IsNonEmptyStringArrayValidatorInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public function validate( mixed $value ): bool
	{
		...
		$elementValidator = new IsNonEmptyStringValidator();
