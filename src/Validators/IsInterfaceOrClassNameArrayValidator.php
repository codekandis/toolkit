 ...
 */
class IsInterfaceOrClassNameArrayValidator extends BaseObject implements IsInterfaceOrClassNameArrayValidatorInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public function validate( mixed $value ): bool
	{
		...
		$elementValidator = new IsInterfaceOrClassNameValidator();
