 ...
 */
class IsDateTimeImmutableArrayValidator extends BaseObject implements IsDateTimeImmutableArrayValidatorInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public function validate( mixed $value ): bool
	{
		...
		$elementValidator = new IsDateTimeImmutableValidator();
