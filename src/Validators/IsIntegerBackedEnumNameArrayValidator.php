 ...
 */
class IsIntegerBackedEnumNameArrayValidator extends BaseObject implements IsIntegerBackedEnumNameArrayValidatorInterface
{
	/**
	 * @inheritdoc
	...
	public function validate( mixed $value ): bool
	{
		...
		$elementValidator = new IsIntegerBackedEnumNameValidator();
