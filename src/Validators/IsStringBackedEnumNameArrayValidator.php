 ...
 */
class IsStringBackedEnumNameArrayValidator extends BaseObject implements IsStringBackedEnumNameArrayValidatorInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public function validate( mixed $value ): bool
	{
		...
		$elementValidator = new IsStringBackedEnumNameValidator();
