 ...
 */
class IsBackedEnumNameArrayValidator extends BaseObject implements IsBackedEnumNameArrayValidatorInterface
{
	/**
	 * @inheritdoc
	...
	public function validate( mixed $value ): bool
	{
		...
		$elementValidator = new IsBackedEnumNameValidator();
