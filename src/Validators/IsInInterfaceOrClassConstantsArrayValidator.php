 ...
 */
class IsInInterfaceOrClassConstantsArrayValidator extends AbstractInterfaceOrClassNameRelatedValidator implements IsInInterfaceOrClassConstantsArrayValidatorInterface
{
	/**
	 * @inheritdoc
	...
	public function validate( mixed $value ): bool
	{
		...
		try
		{
			$elementValidator = new IsInInterfaceOrClassConstantsValidator( $this->interfaceOrClassName );
		}
