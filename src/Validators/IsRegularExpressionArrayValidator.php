 ...
 */
class IsRegularExpressionArrayValidator extends BaseObject implements IsRegularExpressionArrayValidatorInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public function validate( mixed $value ): bool
	{
		...
		$elementValidator = new IsRegularExpressionValidator();
