 ...
 */
class IsInterfaceClassOrEnumNameArrayValidator extends BaseObject implements IsInterfaceClassOrEnumNameArrayValidatorInterface
{
	/**
	 * @inheritdoc
	 */
	...
	public function validate( mixed $value ): bool
	{
		...
		$elementValidator = new IsInterfaceClassOrEnumNameValidator();
